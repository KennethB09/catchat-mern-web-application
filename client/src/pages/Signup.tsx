            ...
            <div className='flex flex-col item-center justify-center py-4 px-8 gap-16 sm:gap-12 sm:w-[45%]'>
                <Form {...form}>
                    <div className='text-center'>
                        ...
                        <p className='text-base text-gray-500 dark:text-slate-100'>Create a new account</p>
                    </div>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 lg:space-y-3">
                        ...
                        />
                        <Button type="submit" className='bg-orange-500 w-full uppercase' disabled={isLoading}>
                            {isLoading ?
