    ...
    return (
        <nav className="flex flex-col h-full">
            <div className="max-w-fit mx-auto mt-9 pb-2 text-center">
                ...
                <UploadImage uploadPurpose='change_user_avatar' userIdOrConversationId={user.userId}/>
            </div>
            <div className="text-orange-500 border-b-2 border-orange-500  dark:border-slate-50 pb-3 mb-4 dark:text-slate-50">
                ...
                <p className="text-sm text-ellipsis whitespace-nowrap overflow-hidden"><span className="font-semibold">E-mail: </span><br />{user.email}</p>
            </div>
